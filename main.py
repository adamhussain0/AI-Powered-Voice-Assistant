...
# todo: opening any file using normal way, through entire PC.
...
def detect_and_open_file(query):
    ...
    if base_filename:
        ...
        for root, dirs, files in os.walk(os.path.expanduser('/')):
            for file in files:
                if extension and file.lower().startswith(base_filename.lower()) and file.lower().endswith(
                        extension.lower()):
...
# todo: opening any file using BFS, through single directory.
...
# todo: replacing symbols when said symbol and # etc.
...
if __name__ == '__main__':
    print('Welcome.')
    say("Hello, I am Stella, an AI voice assistant engineered by Adam. How may I help you.")
    while True:
        print("Listening...")
        query = takeCmnd()

        # todo: opening files using BFS.
